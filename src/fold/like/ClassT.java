...
public class ClassT {
	...
	public static Console c2 = new Console(48, 85);
		...
		do {
			...
			do {
				...
				if (userInput == 1) {
					...
					c.println("Deciding to give the new intern, Loki, a chance, you head over to the nervous man\" Hi, I'm \"" + userName + " Oh, hi sir, is there anything I can do for you?");
					...
					c.println("After sharing all the information you feel satisfied and go on to the lounge for a lunch break. In the lounge you hear other colleagues talking about an upcoming launch party, as you munch on your lunch you continue to shamelessly eavesdrop on their conversation and write down the date and time down in your phone notes.");
					c.println("Exhausted from work, you head home. ");
					break;
				}
