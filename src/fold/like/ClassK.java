...
public class ClassK {
	...
	public static void main(String[] args) throws InterruptedException, IOException{
		...
		pngperson = ImageIO.read(new File("fold/folder.png"));
...
//			} while (check(userInput) == true);
			...
			do {
				...
				if (userInput == 1) {
					...
					c.getChar();
					c.clear();
					c.print("The rest of the day goes well and eventually you reach the end of the work day.");
					c.print("\nExhausted from work, you head home. As soon as you get home,"
							+ "\nyou hit the bed and not long after you fall asleep.\n"
					...
					c.print("\nFeeling pretty confused, you tell the system about the intern."
					...
					c.print("your secretary walks towards you and briefs you on what has happened."
							+ "\nAs you walk into your office you notice a folder on your desk. Confused,"
							+ "\nyou open to see a flood of pictures fall onto your desk. \"What is this?\""
							+ "\nYou look through to see that it is photos of the intern having tea with another man,"
							+ "\nChad, the CEO of our rival company has been seen with our intern."
			...
			c.print("\"It's not too bad, it's not always every day that a company\n"
			...
			c.print("Etil smiles as she nods at your response,"
